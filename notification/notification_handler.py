    ...
    try:
        ...
        for appointment in appointments:
            message_text = (
                ...
                f"Напоминаем, что через 3 часа у вас приём "
            ...
            # Здесь нужно добавить логику получения chat_id по номеру телефона
...
async def get_chat_id_by_phone(phone: str) -> int:
    ...
    """
    # Здесь нужно реализовать получение chat_id из вашей базы данных
    # Пример:
